...
class CitySelectorMulti<T extends Object> extends StatefulWidget {
  final String label;
  ...
  @override
  State<CitySelectorMulti<T>> createState() => _CitySelectorMultiState<T>();
}

class _CitySelectorMultiState<T extends Object>
    extends State<CitySelectorMulti<T>> {
